...
if not st.session_state.get("authenticated", False):
    ...
    with col2:
        ...
        st.markdown("<p style='text-align: center;'>Vui lòng đăng nhập để sử dụng các chức năng quản lý.</p>", unsafe_allow_html=True)
    ...
    with tab1:
        ...
        with col1:
            ...
            <div style='padding: 20px; border-radius: 10px; border: 1px solid #ddd; margin: 10px 0;'>
                ...
                <p>Tạo & quản lý liên kết giấy tờ</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            with col1:
                if st.button("Đơn Xin →", key="goto_field_request"):
                    st.switch_page("pages/field_trip_request.py")
            with col2:
                if st.button("Báo Cáo →", key="goto_field_report"):
                    st.switch_page("pages/field_trip_report.py")
